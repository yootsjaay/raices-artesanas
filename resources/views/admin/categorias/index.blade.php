<x-app-layout>
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-1">
                                            <button
                                                ...
                                                data-modal-toggle="editarCategoriaModal" data-id="{{ $categoria->id }}">
                                            ...
                                            <button
                                                ...
                                                onclick="abrirModalConfirmacion({{ $categoria->id }}, 1)">
                                                <i class="fa-regular fa-trash-can"></i>
                                            </button>
                                            @else
                                            <button
                                                class="p-2 text-yellow-500 rounded-lg hover:bg-yellow-50 dark:hover:bg-gray-700"
                                                onclick="abrirModalConfirmacion({{ $categoria->id }}, 0)">
        ...
        <div class="relative p-4 w-full max-w-2xl">
            ...
            <div
                ...
                <div
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto
                    ...
                    <form action="{{ route('administrador.categorias.store') }}" method="post">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500
                                 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                  dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500 transition-all duration-200" placeholder="Ej. Electrónicos">
                        </div>
                        ...
                        <div class="flex items-center mb-5">
                            <input type="checkbox" name="destacado" id="destacado" value="1"
                                {{ old('destacado') ? 'checked' : '' }} class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:focus:ring-purple-600}
            ...
            <div
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form id="form-editar-categoria">
                            ...
                            <input type="text" name="nombre" id="nombre-editar" required
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
                                 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 transition-all duration-200" placeholder="Ej. Electrónicos">
                        </div>
                        ...
                        <div class="flex justify-center pt-4 border-t border-gray-200 dark:border-gray-700">
                            <button type="submit" class="flex items-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm
        ...
        <div class="relative p-4 w-full max-w-md">
            ...
            <div
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b dark:border-gray-700 rounded-t">
                    ...
                    <button type="button" onclick="cerrarModal('confirmModal')" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto
                         inline-flex justify-center items-center dark:hover:bg-gray-700 dark:hover:text-white">
                        <i class="fas fa-times"></i>
                        <span class="sr-only">Close modal</span>
                    </button>
                ...
                <!-- Modal footer -->
                <div class="flex items-center justify-end p-4 md:p-5 border-t dark:border-gray-700 rounded-b space-x-3">
                    <button type="button" onclick="cerrarModal('confirmModal')" class="py-2 px-4 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 dark:bg-gray-600
    ...
    document.querySelector('#crearCategoriaModal form').addEventListener('submit', function(e) {
        ...
        const storeUrl = '{{ route('administrador.categorias.store') }}';

     fetch(storeUrl, {
    method: 'POST',
    headers: {
        'Content-Type': 'application/json',
        'X-CSRF-TOKEN': csrfToken, // Asegúrate de que esta variable tenga el valor correcto
        'Accept': 'application/json' // Obliga a Laravel a responder con JSON si hay un error
    },
    body: JSON.stringify(jsonData)
            ...
            .then(data => {
                if (data.success) {
                    cerrarModal('crearCategoriaModal');
                    alert(data.message);
    ...
    async function abrirModalConfirmacion(categoriaId, estado) {
        ...
        try {
            ...
            const config = {
                1: {
                    mensaje: `¿Seguro que quieres eliminar la categoría <span class="font-bold">"${categoria.data.caracteristica.nombre}"</span>?`,
                    textoBoton: 'Eliminar',
                    colorBoton: 'bg-red-600 hover:bg-red-700'
                },
                0: {
                    mensaje: `¿Seguro que quieres restaurar la categoría <span class="font-bold">"${categoria.data.caracteristica.nombre}"</span>?`,
            ...
            confirmBtn.setAttribute('data-id', categoriaId);
    ...
    document.getElementById('confirmarEliminacion').addEventListener('click', async function() {
        ...
        const url = `/categorias/${categoriaId}`;
